...
- HOST_DOMAIN - Domain/sub-domain of your application, eg `chinook.example.com` .
...
gh secret set AWS_ECS_CLUSTER -b"<AWS_ECS_CLUSTER, eg chinooks>"
gh secret set HOST_DOMAIN -b"<HOST_DOMAIN, eg chinook.example.com>"
